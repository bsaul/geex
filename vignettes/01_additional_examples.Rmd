...
estimates <- m_estimate(
  estFUN = SB4_estFUN, 
  data  = geexex, 
  root_control = setup_rootFUN(start = c(1, 1, 1, 1)))
```
...
estimates <- m_estimate(
  estFUN = SB5_estFUN, 
  data  = geexex,
  root_control = setup_rootFUN(start = 2))
```
...
estimates <- m_estimate(
  estFUN = SB7_estFUN, 
  data  = geexex, 
  root_control = setup_rootFUN(start = 4.7),
...
estimates <- m_estimate(
  estFUN = SB9_estFUN, 
  data  = geexex, 
  root_control = setup_rootFUN(start = c(.1, .1, .5)))
```
...
estimates <- m_estimate(
  ...
  data  = shaq, 
  units = 'game', 
  root_control = setup_rootFUN(start = c(.5, .5)))
```
